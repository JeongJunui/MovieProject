    ...
    <div class="row"> 
          <nav>
            <ul class="nav_ul">
              ...
              <a class="a_text" href="movieList.jsp"><li class="nav_li">영화</li></a>
              <a class="a_text" href="recommendPage.jsp"><li class="nav_li">추천</li></a>
              <a class="a_text" href="boardPage.jsp"><li class="nav_li">게시판</li></a>
              <a class="a_text" href="qnaPage.jsp"><li class="nav_li">문의</li></a>
            </ul>
          </nav>
        </div>
